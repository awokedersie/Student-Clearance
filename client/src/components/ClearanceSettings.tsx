    ...
    return (
        <AdminLayout user={user}>
            <div className="p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                {/* Status Card */}
                <div className="bg-white rounded-[40px] shadow-xl border border-gray-100 p-10 flex flex-col md:flex-row justify-between items-center gap-8 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 border border-gray-100 px-6 py-5 rounded-3xl focus:ring-4 focus:ring-indigo-500/10 focus:outline-none transition-all font-bold text-gray-800"
                                />
                            </div>
                    ...
                    {/* Stats Card */}
                    <div className="bg-indigo-900 rounded-[40px] shadow-2xl p-10 text-white relative overflow-hidden group">
                        ...
                        <div className="space-y-10 relative z-10">
                            <div>
                                ...
                                <div className="w-full h-6 bg-white/10 rounded-full overflow-hidden p-1 border border-white/5">
                                    <div
                                        className="h-full bg-gradient-to-r from-emerald-400 to-indigo-400 rounded-full transition-all duration-1000 shadow-[0_0_20px_rgba(52,211,153,0.5)]"
