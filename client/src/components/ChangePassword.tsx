    ...
    return (
        <Layout user={user}>
            <div className="max-w-xl mx-auto py-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="bg-white rounded-[40px] shadow-2xl shadow-indigo-100/50 border border-gray-100 p-8 sm:p-12 relative overflow-hidden">
                    {/* Decorative element */}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border-2 border-transparent border-b-gray-100 rounded-2xl px-8 py-5 text-gray-900 font-bold focus:outline-none focus:ring-4 focus:ring-indigo-500/5 focus:border-indigo-600 transition-all placeholder:text-gray-300"
                                required
                            />
                        </div>
