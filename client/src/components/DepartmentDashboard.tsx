    ...
    return (
        <AdminLayout user={user}>
            <div className="p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="bg-gray-900/5 p-6 rounded-[35px] border border-gray-200/50 space-y-4">
                                ...
                                <div className="flex items-center gap-2 animate-in fade-in zoom-in duration-300">
                                    ...
                                    <div className="relative bulk-dropdown-container">
                                        <button
                                            ...
                                            disabled={submitting}
                                            className={`flex items-center gap-3 px-6 py-3 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all ${bulkDropdownOpen
                                        ...
                                        {bulkDropdownOpen && (
                                            <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-2xl shadow-2xl border border-gray-100 py-2 z-[60] animate-in fade-in slide-in-from-top-2 zoom-in-95 duration-200 overflow-hidden">
                                                <button
                                                    onClick={() => {
                        ...
                        <table className="w-full text-left">
                            <thead className="bg-gray-50/50 border-b border-gray-100/50">
                                <tr>
                                    ...
                                    <th className="p-6 text-[10px] font-black text-gray-400 uppercase tracking-widest">Clearance Status</th>
                                    <th className="p-6 text-[10px] font-black text-gray-400 uppercase tracking-widest">Last Update</th>
                                    {!isProtector && (
                                        <th className="p-6 text-[10px] font-black text-gray-400 uppercase tracking-widest text-right">Review Action</th>
                                    )}
                                </tr>
                            </thead>
