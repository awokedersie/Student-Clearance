...
const LandingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0f0c29] via-[#1a1060] to-[#0d1b4b] text-white overflow-x-hidden font-['Outfit',sans-serif]">
            ...
            {/* ── Departments covered ── */}
            <section id="departments" className="px-6 md:px-16 py-16 border-t border-white/5">
                    ...
                    <div className="space-y-5">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <span className="text-white/40 text-sm">+251 939 013 63 0 / +251 11 166 06 00 </span>
                            </li>
                        </ul>
                    </div>
                </div>
